...
```{r, eval=FALSE}
library(recount) #recount package to scale raw counts
...
condition_table = data.frame(name=c(samples_heart, samples_muscle),
                             condition=c(rep('heart',10), rep('muscle', 10)))
```
...
```{r, eval=FALSE}
set.seed(1) # for reproducible subsample combination generation
